...
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_sgx_init_quote, (sgx_att_key_id_t* p_att_key_id, sgx_target_info_t* p_target_info));
#endif
#ifndef OCALL_SGX_GET_QUOTE_SIZE_DEFINED__
#define OCALL_SGX_GET_QUOTE_SIZE_DEFINED__
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_sgx_get_quote_size, (sgx_att_key_id_t* p_att_key_id, uint32_t* p_quote_size));
#endif
#ifndef OCALL_SGX_GET_QUOTE_DEFINED__
#define OCALL_SGX_GET_QUOTE_DEFINED__
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_sgx_get_quote, (sgx_report_t* p_report, sgx_att_key_id_t* p_att_key_id, sgx_qe_report_info_t* p_qe_report_info, uint8_t* p_quote, uint32_t quote_size));
#endif
